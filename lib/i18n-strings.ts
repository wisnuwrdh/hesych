...
export const STRINGS = {
  ...
  "premium.networkError": "Network error. Check your connection and try again.",
  ...
  "lb.enabledOn": "Auto-backup is ON",
  "lb.enabledOff": "Auto-backup is OFF",
  "lb.lastBackup": "Last backup",
  "lb.backupNow": "Back up now",
  "lb.turnOff": "Turn off auto-backup",
  "lb.unsupported": "This browser doesn't support folder access. Use Chrome/Edge on desktop or Android.",
  "lb.saved": "Encrypted snapshot written.",
  ...
  "premium.activatedOn": "Activated {date}",
  ...
  "health.breachedTitle": "Breached Passwords",
  "health.breachedDesc": "{n} passwords appeared in known data breaches",
  "health.noBreach": "No breached passwords ✓",
  "health.empty": "No items in your vault yet",
  "health.scanErr": "Health scan failed",
  "health.recap": "{total} items · {checked} checked",
